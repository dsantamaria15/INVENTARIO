<?php
session_start();
if (isset($_SESSION['us_tipo']) ==1 || $_SESSION['us_tipo'] == 3) {
...
?>
    ...
    <div class="modal-content">
        <div class="card card-success">
            ...
            <div class="card-body">
            <div class="alert alert-success text-center" id="agregado-laboratorio" style="display:none;">
                <span><i class="fas fa-check m-1"></i>Se agrego correctamente</span>
                </div>
                <div class="alert alert-danger text-center" id="no_agregado-laboratorio" style="display:none;">
