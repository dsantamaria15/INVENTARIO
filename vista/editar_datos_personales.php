            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="card-body">
                        ...
                        <p id="telefono_us" class="text-muted">465464646</p>
                        <strong style="color: #0B7300">
                            <i class="fas fa-map-marker-alt mr-1">Residencia</i>
                        </strong>
                        <p id="residencia_us"class="text-muted">Bogotá</p>
                        <strong style="color: #0B7300">
                            <i class="fas fa-at mr-1">Correo</i>
                        </strong>
                        <p id="correo_us" class="text-muted">Gmail.com</p>
                        <strong style="color: #0B7300">
                        ...
                        <p id="adicional_us" class="text-muted">Soy una persona......</p>
