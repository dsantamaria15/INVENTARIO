            ...
            <div usuarioId="${usuario.id}" class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch">
              <div class="card bg-light">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead">${usuario.nombre} ${usuario.apellidos}<b></b></h2>
                ...
                if(tipo_usuario==3){
                  if(usuario.tipo_usuario!=3){
                    template+=`
                    <button class="borrar-usuario btn btn-danger mr-1" ype="button" data-toggle="modal" data-target="#confirmar">
